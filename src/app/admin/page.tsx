"use client";
import { Users, UserPlus, Settings, BarChart3, Shield, LogOut } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-red-200 text-sm mt-1">
                Role: {currentUser?.role === 'SUPER_ADMIN' ? 'Super Administrator' : 'Administrator'}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">System Overview</h3>
            <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <Users className="mr-3 text-brand-secondary-blue group-hover:text-blue-700" size={20} />
              <div>
                <div className="font-semibold text-gray-800">View All Users</div>
                <div className="text-gray-600 text-sm">Manage existing user accounts</div>
              </div>
            </Link>
            ...
            <Link 
              ...
              className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors group"
            >
              <UserPlus className="mr-3 text-brand-secondary-green group-hover:text-green-700" size={20} />
              <div>
                <div className="font-semibold text-gray-800">Create New User</div>
                <div className="text-gray-600 text-sm">Add a new user to the system</div>
              </div>
            </Link>
          </div>
        </div>
        ...
        {currentUser?.role === 'SUPER_ADMIN' && (
          <div className="mt-8 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-6">
            ...
            <p className="text-amber-700 text-sm">
              As a Super Administrator, you have full access to all system features including the ability to create and manage other administrators.
            </p>
          </div>
        )}
      </div>
